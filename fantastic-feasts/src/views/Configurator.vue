<template>
  <section>
    ...
    <div class="app__content">
      ...
      <div
        v-if="
          state.currentState === 'inTeamOverview' ||
            state.currentState === 'inMatchOverview'
        "
      ...
      <app-team-config
        v-if="state.currentState === 'inTeamConfig'"
        :game="game"
        :state="state"
        :configs="configs"
      ></app-team-config>
      <app-match-config
        v-if="state.currentState === 'inMatchConfig'"
        :game="game"
        :state="state"
        :configs="configs"
      ></app-match-config>
      <app-team-overview
        v-if="state.currentState === 'inTeamOverview'"
        :game="game"
        :state="state"
        :configs="configs"
      ></app-team-overview>
      <app-match-overview
        v-if="state.currentState === 'inMatchOverview'"
        :game="game"
        :state="state"
        :configs="configs"
      ></app-match-overview>
...
.config__header-button:active {
  background: #fcf2da;
  -moz-box-shadow: inset 0 0 0.8vw #00000036;
  -webkit-box-shadow: inset 0 0 0.8vw #00000036;
  box-shadow: inset 0 0 0.8vw #00000036;
}
