    ...
    <div class="team-container">
      <div class="overview-list">
        ...
        <transition-group name="slide">
          <li
            v-for="(match, index) in configs.matchConfigs"
            :key="match.name"
  ...
  methods: {
    ...
    downloadJSON() {
      var dataStr =
        ...
        encodeURIComponent(
          JSON.stringify(this.configs.matchConfigs[this.selectedItem].config)
        );
      var downloadAnchorNode = document.createElement("a");
      downloadAnchorNode.setAttribute("href", dataStr);
      downloadAnchorNode.setAttribute(
        "download",
        this.configs.matchConfigs[this.selectedItem].name.toLowerCase() +
          ".json"
      );
