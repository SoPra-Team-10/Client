<template>
  <div id="player-info-panel" class="info-panel">
    ...
    <transition name="fade">
      <div
        v-if="snapShot.phase === 'playerPhase'"
        class="player-detail-container"
      >
        <div
          class="player-detail-icon"
          :style="{
            background:
              'radial-gradient(#ffffff0a, #0000003f), #' +
              playerToDisplay.colorPrimary
          }"
        >
        ...
        <div class="player-detail-name-container">
          ...
          <div class="player-detail-broom">
            <i> {{ playerToDisplay.teamName }}</i>
          </div>
          <div class="player-detail-broom">{{ playerToDisplay.broom }}</div>
          <div class="player-detail-type">{{ playerToDisplay.role }}</div>
          <div class="player-detail-type">
            ({{ playerToDisplay.xPos }} | {{ playerToDisplay.yPos }})
          </div>
        </div>
